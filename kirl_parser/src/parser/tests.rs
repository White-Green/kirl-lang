...
use crate::parser::{AnonymousStructType, Block, Condition, ConstructStruct, Expression, ExpressionItem, Function, get_syntax, If, KirlTopLevelStatement, LetBinding, NamedType, Path, Pattern, Statement, StatementItem, StructName, Symbol, Type};
...
"#;
    ...
    assert_eq!(parse(CODE_1), Ok(Symbol::ValidKirlCode(
        (
            CharacterPosition::new(0, 0)..CharacterPosition::new(7, 1),
            vec![
                KirlTopLevelStatement::FunctionDefinition(
                    (
                        CharacterPosition::new(0, 0)..CharacterPosition::new(7, 1),
                        Function {
                            ...
                            return_type: Type::AnonymousStruct(
                                AnonymousStructType {
                                    ...
                                    last_expression: Some(Expression {
                                        ...
                                        expression: ExpressionItem::If(If {
                                            ...
                                            condition: Condition::BoolExpression(Expression {
                                                ...
                                                expression: ExpressionItem::GreaterThan(Expression {
                                                        ...
                                                        Statement {
                                                            ...
                                                            statement: StatementItem::LetBinding(LetBinding {
                                                                ...
                                                                expression: Expression {
                                                                    ...
                                                                    expression: ExpressionItem::Mul(Expression {
