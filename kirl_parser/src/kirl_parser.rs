    ...
    pub fn get_parser() -> LR1Parser {
        ...
        <ValidKirlCode>::=: [] => Ok(Symbol::ValidKirlCode(Default::default()));
            |<ValidKirlCode> <Statement>: list => match list {
                [NonTerminal(Symbol::ValidKirlCode((_, list))), NonTerminal(Symbol::Statement((range, statement)))] if list.is_empty() => Ok(Symbol::ValidKirlCode((range.clone(), vec![KirlTopLevelStatement::Statement((mem::take(range), mem::take(statement)))]))),
        ...
        <Type>::=[Identifier]: [Terminal(Token::Identifier((position, ident)))] => Ok(Symbol::Type((position.clone(), Type::NamedType(NamedType { position: position.clone(), path: vec![ident.clone()], generics_arguments: Vec::new() }))));
           |"!": [Terminal(Token::Not(position))] => Ok(Symbol::Type((position.clone(), Type::Unreachable(position.clone()))));
           |[Identifier] "::" "<" <CommaSeparatedTypes> ">": [Terminal(Token::Identifier((Range { start, .. }, name))), _, _, NonTerminal(Symbol::CommaSeparatedTypes((_, types))), Terminal(Token::GreaterThan(Range { end, .. }))] => Ok(Symbol::Type((*start..*end, Type::NamedType(NamedType { position: *start..*end, path: vec![name.clone()], generics_arguments: mem::take(types) }))));
           |<FullPath>: [NonTerminal(Symbol::FullPath((symbol_position, Path { position, path })))] => Ok(Symbol::Type((mem::take(symbol_position), Type::NamedType(NamedType {
                    position: position.clone(),
                    path: mem::take(path),
                    generics_arguments: Vec::new(),
                }))));
            |<FullPath> "::" "<" <CommaSeparatedTypes> ">": [NonTerminal(Symbol::FullPath((Range { start, .. }, Path { path, .. }))), _, _, NonTerminal(Symbol::CommaSeparatedTypes((_, types))), Terminal(Token::GreaterThan(Range { end, .. }))] => Ok(Symbol::Type((*start..*end, Type::NamedType(NamedType {
                    position: *start..*end,
                    path: mem::take(path),
                    generics_arguments: mem::take(types),
                }))));
            |"[" <Type> "]": [Terminal(Token::SquareBracketOpen(Range { start, .. })), NonTerminal(Symbol::Type((_, inner_type))), Terminal(Token::SquareBracketClose(Range { end, .. }))] => Ok(Symbol::Type((*start..*end, Type::Array(*start..*end, Box::new(mem::take(inner_type))))));
            |"(" <Type> ")": [Terminal(Token::RoundBracketOpen(Range { start, .. })), NonTerminal(Symbol::Type((_, inner_type))), Terminal(Token::RoundBracketClose(Range { end, .. }))] => Ok(Symbol::Type((*start..*end, mem::take(inner_type))));
            |"(" <Type> "," ")": [Terminal(Token::RoundBracketOpen(Range { start, .. })), NonTerminal(Symbol::Type((_, inner_type))), _, Terminal(Token::RoundBracketClose(Range { end, .. }))] => Ok(Symbol::Type((*start..*end, Type::Tuple(*start..*end, vec![mem::take(inner_type)]))));
            |"(" <CommaSeparatedTypes> ")": [Terminal(Token::RoundBracketOpen(Range { start, .. })), NonTerminal(Symbol::CommaSeparatedTypes((_, types))), Terminal(Token::RoundBracketClose(Range { end, .. }))] => Ok(Symbol::Type((*start..*end, Type::Tuple(*start..*end, mem::take(types)))));
            |"#" "{" <StructDefinitionItems> "}": [Terminal(Token::Sharp(Range { start, .. })), _, NonTerminal(Symbol::StructDefinitionItems((_, members))), Terminal(Token::WaveBracketClose(Range { end, .. }))] => Ok(Symbol::Type((*start..*end, Type::AnonymousStruct(AnonymousStructType { position: *start..*end, members: mem::take(members) }))));
            |"(" ")" "->" <Type>: [Terminal(Token::RoundBracketOpen(Range { start, .. })), _, _, NonTerminal(Symbol::Type((Range { end, .. }, return_type)))] => Ok(Symbol::Type((*start..*end, Type::Function(FunctionType {
                    position: *start..*end,
                    argument: Vec::new(),
            ...
            |"(" <CommaSeparatedTypes> ")" "->" <Type>: [Terminal(Token::RoundBracketOpen(Range { start, .. })), NonTerminal(Symbol::CommaSeparatedTypes((_, arguments))), _, _, NonTerminal(Symbol::Type((Range { end, .. }, return_type)))] => Ok(Symbol::Type((*start..*end, Type::Function(FunctionType {
                    position: *start..*end,
                    argument: mem::take(arguments),
                    result: Box::new(mem::take(return_type)),
                }))));
            |"(" <OrSeparatedTypes> ")": [Terminal(Token::RoundBracketOpen(Range { start, .. })), NonTerminal(Symbol::OrSeparatedTypes((_, types))), Terminal(Token::RoundBracketClose(Range { end, .. }))] => Ok(Symbol::Type((*start..*end, Type::Or(*start..*end, mem::take(types)))));
        <FullPath>::=[Identifier] "::" [Identifier]: [Terminal(Token::Identifier((Range { start, .. }, first))), _, Terminal(Token::Identifier((Range { end, .. }, second)))] => Ok(Symbol::FullPath((*start..*end, Path { position: *start..*end, path: vec![first.clone(), second.clone()] })));
        ...
        <OrSeparatedTypes>::=<Type> "|" <Type>: [NonTerminal(Symbol::Type((Range { start, .. }, first))), _, NonTerminal(Symbol::Type((Range { end, .. }, second)))] => Ok(Symbol::OrSeparatedTypes((*start..*end, vec![mem::take(first), mem::take(second)])));
            |<OrSeparatedTypes> "|" <Type>: [NonTerminal(Symbol::OrSeparatedTypes((Range { start, .. }, types))), _, NonTerminal(Symbol::Type((Range { end, .. }, last)))] => Ok(Symbol::OrSeparatedTypes((*start..*end, {
                    types.push(mem::take(last));
                    mem::take(types)
                })));
        ...
        <Statement>::=<ImportStatement>: [NonTerminal(Symbol::ImportStatement((position, path)))] => Ok(Symbol::Statement((position.clone(), Statement { position: position.clone(), statement: StatementItem::Import(mem::take(path)) })));
           |<Expression> ";": [NonTerminal(Symbol::Expression((Range { start, .. }, expression))), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::Statement((*start..*end, Statement { position: *start..*end, statement: StatementItem::Expression(mem::take(expression)) })));
           |<LetBinding> ";": [NonTerminal(Symbol::LetBinding((Range { start, .. }, let_binding))), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::Statement((*start..*end, Statement { position: *start..*end, statement: StatementItem::LetBinding(mem::take(let_binding)) })));
           |"return" <Expression> ";": [Terminal(Token::Return(Range { start, .. })), NonTerminal(Symbol::Expression((_, expression))), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::Statement((*start..*end, Statement { position: *start..*end, statement: StatementItem::Return(Some(mem::take(expression))) })));
           |"return" ";": [Terminal(Token::Return(Range { start, .. })), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::Statement((*start..*end, Statement { position: *start..*end, statement: StatementItem::Return(None) })));
           |"continue" ";": [Terminal(Token::Continue(Range { start, .. })), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::Statement((*start..*end, Statement { position: *start..*end, statement: StatementItem::Continue(None) })));
           |"continue" [Identifier] ";": [Terminal(Token::Continue(Range { start, .. })), Terminal(Token::Identifier((_, label))), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::Statement((*start..*end, Statement { position: *start..*end, statement: StatementItem::Continue(Some(label.clone())) })));
           |"break" ";": [Terminal(Token::Break(Range { start, .. })), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::Statement((*start..*end, Statement { position: *start..*end, statement: StatementItem::Break(None) })));
           |"break" [Identifier] ";": [Terminal(Token::Break(Range { start, .. })), Terminal(Token::Identifier((_, label))), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::Statement((*start..*end, Statement { position: *start..*end, statement: StatementItem::Break(Some(label.clone())) })));
           |<ForStatement>: [NonTerminal(Symbol::ForStatement((position, for_statement)))] => Ok(Symbol::Statement((position.clone(), Statement { position: position.clone(), statement: StatementItem::For(mem::take(for_statement)) })));
           |<WhileStatement>: [NonTerminal(Symbol::WhileStatement((position, while_statement)))] => Ok(Symbol::Statement((position.clone(), Statement { position: position.clone(), statement: StatementItem::While(mem::take(while_statement)) })));
        ...
        <Block>::="{" <StatementList> <Expression> "}": [Terminal(Token::WaveBracketOpen(Range { start, .. })), NonTerminal(Symbol::StatementList((_, list))), NonTerminal(Symbol::Expression((_, expression))), Terminal(Token::WaveBracketClose(Range { end, .. }))] => Ok(Symbol::Block((*start..*end, Block {
                    position: *start..*end,
                    statements: mem::take(list),
                    last_expression: Some(Box::new(mem::take(expression))),
                })));
            |"{" <StatementList> "}": [Terminal(Token::WaveBracketOpen(Range { start, .. })), NonTerminal(Symbol::StatementList((_, list))), Terminal(Token::WaveBracketClose(Range { end, .. }))] => Ok(Symbol::Block((*start..*end, Block {
                    position: *start..*end,
                    statements: mem::take(list),
                    last_expression: None,
                })));
            |"{" <Expression> "}": [Terminal(Token::WaveBracketOpen(Range { start, .. })), NonTerminal(Symbol::Expression((_, expression))), Terminal(Token::WaveBracketClose(Range { end, .. }))] => Ok(Symbol::Block((*start..*end, Block {
                    position: *start..*end,
                    statements: Vec::new(),
                    last_expression: Some(Box::new(mem::take(expression))),
                })));
            |"{" "}": [Terminal(Token::WaveBracketOpen(Range { start, .. })), Terminal(Token::WaveBracketClose(Range { end, .. }))] => Ok(Symbol::Block((*start..*end, Block {
                    position: *start..*end,
                    statements: Vec::new(),
                    last_expression: None,
                })));
        <Expression8>::=[Identifier]: [Terminal(Token::Identifier((position, variable)))] => Ok(Symbol::Expression8((position.clone(), Expression { position: position.clone(), expression: ExpressionItem::AccessVariable(Path { position: position.clone(), path: vec![variable.clone()] }) })));
            ...
            |<Expression8> "." [Identifier] "(" ")": [NonTerminal(Symbol::Expression8((Range { start, .. }, expression))), _, Terminal(Token::Identifier((position, path))), _, Terminal(Token::RoundBracketClose(Range { end, .. }))] => Ok(Symbol::Expression8((*start..*end, Expression { position: *start..*end, expression: ExpressionItem::CallFunction(Some(Box::new(mem::take(expression))), Some(Path { position: position.clone(), path: vec![path.clone()] }), Vec::new()) })));
            ...
            |[Identifier] "(" ")": [Terminal(Token::Identifier((position, path))), _, Terminal(Token::RoundBracketClose(Range { end, .. }))] => Ok(Symbol::Expression8((position.start..*end, Expression { position: position.start..*end, expression: ExpressionItem::CallFunction(None, Some(Path { position: position.clone(), path: vec![path.clone()] }), Vec::new()) })));
            ...
            |<Expression8> "." [Identifier] "(" <Expression> ")": [NonTerminal(Symbol::Expression8((Range { start, .. }, expression))), _, Terminal(Token::Identifier((position, path))), _, NonTerminal(Symbol::Expression((_, argument))), Terminal(Token::RoundBracketClose(Range { end, .. }))] => Ok(Symbol::Expression8((*start..*end, Expression { position: *start..*end, expression: ExpressionItem::CallFunction(Some(Box::new(mem::take(expression))), Some(Path { position: position.clone(), path: vec![path.clone()] }), vec![mem::take(argument)]) })));
            ...
            |[Identifier] "(" <Expression> ")": [Terminal(Token::Identifier((position, path))), _, NonTerminal(Symbol::Expression((_, argument))), Terminal(Token::RoundBracketClose(Range { end, .. }))] => Ok(Symbol::Expression8((position.start..*end, Expression { position: position.start..*end, expression: ExpressionItem::CallFunction(None, Some(Path { position: position.clone(), path: vec![path.clone()] }), vec![mem::take(argument)]) })));
            ...
            |<Expression8> "." [Identifier] "(" <CommaSeparatedExpressions> ")": [NonTerminal(Symbol::Expression8((Range { start, .. }, expression))), _, Terminal(Token::Identifier((position, path))), _, NonTerminal(Symbol::CommaSeparatedExpressions((_, arguments))), Terminal(Token::RoundBracketClose(Range { end, .. }))] => Ok(Symbol::Expression8((*start..*end, Expression { position: *start..*end, expression: ExpressionItem::CallFunction(Some(Box::new(mem::take(expression))), Some(Path { position: position.clone(), path: vec![path.clone()] }), mem::take(arguments)) })));
            ...
            |[Identifier] "(" <CommaSeparatedExpressions> ")": [Terminal(Token::Identifier((position, path))), _, NonTerminal(Symbol::CommaSeparatedExpressions((_, arguments))), Terminal(Token::RoundBracketClose(Range { end, .. }))] => Ok(Symbol::Expression8((position.start..*end, Expression { position: position.start..*end, expression: ExpressionItem::CallFunction(None, Some(Path { position: position.clone(), path: vec![path.clone()] }), mem::take(arguments)) })));
            ...
            |<Block>: [NonTerminal(Symbol::Block((position, block)))] => Ok(Symbol::Expression8((position.clone(), Expression { position: position.clone(), expression: ExpressionItem::Block(mem::take(block)) })));
            |<FullPath>: [NonTerminal(Symbol::FullPath((position, path)))] => Ok(Symbol::Expression8((position.clone(), Expression { position: position.clone(), expression: ExpressionItem::AccessVariable(mem::take(path)) })));
        ...
        <ClosureExpression>::="fn" ":" <ClosureArguments> "|" "->" <Expression>: [Terminal(Token::Fn(Range { start, .. })), _, NonTerminal(Symbol::ClosureArguments((_, arguments))), _, _, NonTerminal(Symbol::Expression((Range { end, .. }, expression)))] => Ok(Symbol::ClosureExpression((*start..*end, Closure { position: *start..*end, arguments: mem::take(arguments), expression: Box::new(mem::take(expression)) })));
            |"fn" ":" "|" "->" <Expression>: [Terminal(Token::Fn(Range { start, .. })), _, _, _, NonTerminal(Symbol::Expression((Range { end, .. }, expression)))] => Ok(Symbol::ClosureExpression((*start..*end, Closure { position: *start..*end, arguments: Vec::new(), expression: Box::new(mem::take(expression)) })));
        <IfExpression>::="if" <Expression> <Block>: [Terminal(Token::If(Range { start, .. })), NonTerminal(Symbol::Expression((_, condition))), NonTerminal(Symbol::Block((Range { end, .. }, block)))] => Ok(Symbol::IfExpression((*start..*end, If { position: *start..*end, condition: Box::new(Condition::BoolExpression(mem::take(condition))), then: Box::new(Expression { position: block.position.clone(), expression: ExpressionItem::Block(mem::take(block)) }), other: None })));
            |"if" <Expression> <Block> "else" <Block>: [Terminal(Token::If(Range { start, .. })), NonTerminal(Symbol::Expression((_, condition))), NonTerminal(Symbol::Block((_, then))), _, NonTerminal(Symbol::Block((Range { end, .. }, other)))] => Ok(Symbol::IfExpression((*start..*end, If { position: *start..*end, condition: Box::new(Condition::BoolExpression(mem::take(condition))), then: Box::new(Expression { position: then.position.clone(), expression: ExpressionItem::Block(mem::take(then)) }), other: Some(Box::new(Expression { position: other.position.clone(), expression: ExpressionItem::Block(mem::take(other)) })) })));
            |"if" <Expression> <Block> "else" <IfExpression>: [Terminal(Token::If(Range { start, .. })), NonTerminal(Symbol::Expression((_, condition))), NonTerminal(Symbol::Block((_, then))), _, NonTerminal(Symbol::IfExpression((Range { end, .. }, expression)))] => Ok(Symbol::IfExpression((*start..*end, If { position: *start..*end, condition: Box::new(Condition::BoolExpression(mem::take(condition))), then: Box::new(Expression { position: then.position.clone(), expression: ExpressionItem::Block(mem::take(then)) }), other: Some(Box::new(Expression { position: expression.position.clone(), expression: ExpressionItem::If(mem::take(expression)) })) })));
            |"if" <LetBinding> <Block>: [Terminal(Token::If(Range { start, .. })), NonTerminal(Symbol::LetBinding((_, condition))), NonTerminal(Symbol::Block((Range { end, .. }, then)))] => Ok(Symbol::IfExpression((*start..*end, If { position: *start..*end, condition: Box::new(Condition::LetBinding(mem::take(condition))), then: Box::new(Expression { position: then.position.clone(), expression: ExpressionItem::Block(mem::take(then)) }), other: None })));
            |"if" <LetBinding> <Block> "else" <Block>: [Terminal(Token::If(Range { start, .. })), NonTerminal(Symbol::LetBinding((_, condition))), NonTerminal(Symbol::Block((_, then))), _, NonTerminal(Symbol::Block((Range { end, .. }, other)))] => Ok(Symbol::IfExpression((*start..*end, If { position: *start..*end, condition: Box::new(Condition::LetBinding(mem::take(condition))), then: Box::new(Expression { position: then.position.clone(), expression: ExpressionItem::Block(mem::take(then)) }), other: Some(Box::new(Expression { position: other.position.clone(), expression: ExpressionItem::Block(mem::take(other)) })) })));
            |"if" <LetBinding> <Block> "else" <IfExpression>: [Terminal(Token::If(Range { start, .. })), NonTerminal(Symbol::LetBinding((_, condition))), NonTerminal(Symbol::Block((_, then))), _, NonTerminal(Symbol::IfExpression((Range { end, .. }, other)))] => Ok(Symbol::IfExpression((*start..*end, If { position: *start..*end, condition: Box::new(Condition::LetBinding(mem::take(condition))), then: Box::new(Expression { position: then.position.clone(), expression: ExpressionItem::Block(mem::take(then)) }), other: Some(Box::new(Expression { position: other.position.clone(), expression: ExpressionItem::If(mem::take(other)) })) })));
        ...
        <ForStatement>::="for" <Pattern> "in" <Expression> <Block>: [Terminal(Token::For(Range { start, .. })), NonTerminal(Symbol::Pattern((_, pattern))), _, NonTerminal(Symbol::Expression((_, iter))), NonTerminal(Symbol::Block((Range { end, .. }, block)))] => Ok(Symbol::ForStatement((*start..*end, ForStatement { label: None, position: *start..*end, pattern: mem::take(pattern), iter: mem::take(iter), block: mem::take(block) })));
            |[Identifier] ":" "for" <Pattern> "in" <Expression> <Block>: [Terminal(Token::Identifier((Range { start, .. }, label))), _, _, NonTerminal(Symbol::Pattern((_, pattern))), _, NonTerminal(Symbol::Expression((_, iter))), NonTerminal(Symbol::Block((Range { end, .. }, block)))] => Ok(Symbol::ForStatement((*start..*end, ForStatement { label: Some(label.clone()), position: *start..*end, pattern: mem::take(pattern), iter: mem::take(iter), block: mem::take(block) })));
        <WhileStatement>::="while" <Expression> <Block>: [Terminal(Token::While(Range { start, .. })), NonTerminal(Symbol::Expression((_, condition))), NonTerminal(Symbol::Block((Range { end, .. }, block)))] => Ok(Symbol::WhileStatement((*start..*end, WhileStatement { label: None, position: *start..*end, condition: Condition::BoolExpression(mem::take(condition)), block: mem::take(block) })));
            |"while" <LetBinding> <Block>: [Terminal(Token::While(Range { start, .. })), NonTerminal(Symbol::LetBinding((_, condition))), NonTerminal(Symbol::Block((Range { end, .. }, block)))] => Ok(Symbol::WhileStatement((*start..*end, WhileStatement { label: None, position: *start..*end, condition: Condition::LetBinding(mem::take(condition)), block: mem::take(block) })));
            |[Identifier] ":" "while" <Expression> <Block>: [Terminal(Token::Identifier((Range { start, .. }, label))), _, _, NonTerminal(Symbol::Expression((_, condition))), NonTerminal(Symbol::Block((Range { end, .. }, block)))] => Ok(Symbol::WhileStatement((*start..*end, WhileStatement { label: Some(label.clone()), position: *start..*end, condition: Condition::BoolExpression(mem::take(condition)), block: mem::take(block) })));
            |[Identifier] ":" "while" <LetBinding> <Block>: [Terminal(Token::Identifier((Range { start, .. }, label))), _, _, NonTerminal(Symbol::LetBinding((_, condition))), NonTerminal(Symbol::Block((Range { end, .. }, block)))] => Ok(Symbol::WhileStatement((*start..*end, WhileStatement { label: Some(label.clone()), position: *start..*end, condition: Condition::LetBinding(mem::take(condition)), block: mem::take(block) })));
        ...
        <ClosureArguments>::=[Identifier]: [Terminal(Token::Identifier((position, name)))] => Ok(Symbol::ClosureArguments((position.clone(), vec![(name.clone(), None)])));
            |[Identifier] ":" <Type>: [Terminal(Token::Identifier((Range { start, .. }, name))), _, NonTerminal(Symbol::Type((Range { end, .. }, t)))] => Ok(Symbol::ClosureArguments((*start..*end, vec![(name.clone(), Some(mem::take(t)))])));
            |<ClosureArguments> "," [Identifier]: [NonTerminal(Symbol::ClosureArguments((Range { start, .. }, list))), _, Terminal(Token::Identifier((Range { end, .. }, name)))] => Ok(Symbol::ClosureArguments((*start..*end, {
                    list.push((name.clone(), None));
                    mem::take(list)
                })));
        <ClosureArguments>::=<ClosureArguments> "," [Identifier] ":" <Type>: [NonTerminal(Symbol::ClosureArguments((Range { start, .. }, list))), _, Terminal(Token::Identifier((_, name))), _, NonTerminal(Symbol::Type((Range { end, .. }, t)))] => Ok(Symbol::ClosureArguments((*start..*end, {
        ...
        <FunctionDefinition>::="fn" [Identifier] "(" <FunctionArguments> ")" "->" <Type> <Block>: [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, NonTerminal(Symbol::FunctionArguments((_, arguments))), _, _, NonTerminal(Symbol::Type((_, t))), NonTerminal(Symbol::Block((Range { end, .. }, expression)))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: Vec::new(), arguments: mem::take(arguments), return_type: mem::take(t), expression: Expression { position: expression.position.clone(), expression: ExpressionItem::Block(mem::take(expression)) } })));
            |"fn" [Identifier] "(" <FunctionArguments> ")" <Block>: [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, NonTerminal(Symbol::FunctionArguments((_, arguments))), _, NonTerminal(Symbol::Block((Range { end, .. }, expression)))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: Vec::new(), arguments: mem::take(arguments), return_type: Type::None, expression: Expression { position: expression.position.clone(), expression: ExpressionItem::Block(mem::take(expression)) } })));
            |"fn" [Identifier] "::" "<" <GenericsTypeArguments> ">" "(" <FunctionArguments> ")" "->" <Type> <Block>: [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, _, NonTerminal(Symbol::GenericsTypeArguments((_, generics_arguments))), _, _, NonTerminal(Symbol::FunctionArguments((_, arguments))), _, _, NonTerminal(Symbol::Type((_, t))), NonTerminal(Symbol::Block((Range { end, .. }, expression)))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: mem::take(generics_arguments), arguments: mem::take(arguments), return_type: mem::take(t), expression: Expression { position: expression.position.clone(), expression: ExpressionItem::Block(mem::take(expression)) } })));
            |"fn" [Identifier] "::" "<" <GenericsTypeArguments> ">" "(" <FunctionArguments> ")" <Block>: [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, _, NonTerminal(Symbol::GenericsTypeArguments((_, generics_arguments))), _, _, NonTerminal(Symbol::FunctionArguments((_, arguments))), _, NonTerminal(Symbol::Block((Range { end, .. }, expression)))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: mem::take(generics_arguments), arguments: mem::take(arguments), return_type: Type::None, expression: Expression { position: expression.position.clone(), expression: ExpressionItem::Block(mem::take(expression)) } })));
            |"fn" [Identifier] "(" <FunctionArguments> "," ")" "->" <Type> <Block>: [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, NonTerminal(Symbol::FunctionArguments((_, arguments))), _, _, _, NonTerminal(Symbol::Type((_, t))), NonTerminal(Symbol::Block((Range { end, .. }, expression)))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: Vec::new(), arguments: mem::take(arguments), return_type: mem::take(t), expression: Expression { position: expression.position.clone(), expression: ExpressionItem::Block(mem::take(expression)) } })));
            |"fn" [Identifier] "(" <FunctionArguments> "," ")" <Block>: [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, NonTerminal(Symbol::FunctionArguments((_, arguments))), _, _, NonTerminal(Symbol::Block((Range { end, .. }, expression)))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: Vec::new(), arguments: mem::take(arguments), return_type: Type::None, expression: Expression { position: expression.position.clone(), expression: ExpressionItem::Block(mem::take(expression)) } })));
            |"fn" [Identifier] "::" "<" <GenericsTypeArguments> ">" "(" <FunctionArguments> "," ")" "->" <Type> <Block>: [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, _, NonTerminal(Symbol::GenericsTypeArguments((_, generics_arguments))), _, _, NonTerminal(Symbol::FunctionArguments((_, arguments))), _, _, _, NonTerminal(Symbol::Type((_, t))), NonTerminal(Symbol::Block((Range { end, .. }, expression)))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: mem::take(generics_arguments), arguments: mem::take(arguments), return_type: mem::take(t), expression: Expression { position: expression.position.clone(), expression: ExpressionItem::Block(mem::take(expression)) } })));
            |"fn" [Identifier] "::" "<" <GenericsTypeArguments> ">" "(" <FunctionArguments> "," ")" <Block>: [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, _, NonTerminal(Symbol::GenericsTypeArguments((_, generics_arguments))), _, _, NonTerminal(Symbol::FunctionArguments((_, arguments))), _, _, NonTerminal(Symbol::Block((Range { end, .. }, expression)))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: mem::take(generics_arguments), arguments: mem::take(arguments), return_type: Type::None, expression: Expression { position: expression.position.clone(), expression: ExpressionItem::Block(mem::take(expression)) } })));
            |"fn" [Identifier] "(" ")" "->" <Type> <Block>: [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, _, _, NonTerminal(Symbol::Type((_, t))), NonTerminal(Symbol::Block((Range { end, .. }, expression)))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: Vec::new(), arguments: Vec::new(), return_type: mem::take(t), expression: Expression { position: expression.position.clone(), expression: ExpressionItem::Block(mem::take(expression)) } })));
            |"fn" [Identifier] "(" ")" <Block>: [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, _, NonTerminal(Symbol::Block((Range { end, .. }, expression)))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: Vec::new(), arguments: Vec::new(), return_type: Type::None, expression: Expression { position: expression.position.clone(), expression: ExpressionItem::Block(mem::take(expression)) } })));
            |"fn" [Identifier] "::" "<" <GenericsTypeArguments> ">" "(" ")" "->" <Type> <Block>: [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, _, NonTerminal(Symbol::GenericsTypeArguments((_, generics_arguments))), _, _, _, _, NonTerminal(Symbol::Type((_, t))), NonTerminal(Symbol::Block((Range { end, .. }, expression)))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: mem::take(generics_arguments), arguments: Vec::new(), return_type: mem::take(t), expression: Expression { position: expression.position.clone(), expression: ExpressionItem::Block(mem::take(expression)) } })));
            |"fn" [Identifier] "::" "<" <GenericsTypeArguments> ">" "(" ")" <Block>: [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, _, NonTerminal(Symbol::GenericsTypeArguments((_, generics_arguments))), _, _, _, NonTerminal(Symbol::Block((Range { end, .. }, expression)))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: mem::take(generics_arguments), arguments: Vec::new(), return_type: Type::None, expression: Expression { position: expression.position.clone(), expression: ExpressionItem::Block(mem::take(expression)) } })));
            |"fn" [Identifier] "(" <FunctionArguments> ")" "->" <Type> "|" "->" <Expression> ";": [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, NonTerminal(Symbol::FunctionArguments((_, arguments))), _, _, NonTerminal(Symbol::Type((_, t))), Terminal(Token::Or(_)), _, NonTerminal(Symbol::Expression((_, expression))), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: Vec::new(), arguments: mem::take(arguments), return_type: mem::take(t), expression: mem::take(expression) })));
            |"fn" [Identifier] "(" <FunctionArguments> ")" "|" "->" <Expression> ";": [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, NonTerminal(Symbol::FunctionArguments((_, arguments))), _, Terminal(Token::Or(_)), _, NonTerminal(Symbol::Expression((_, expression))), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: Vec::new(), arguments: mem::take(arguments), return_type: Type::None, expression: mem::take(expression) })));
            |"fn" [Identifier] "::" "<" <GenericsTypeArguments> ">" "(" <FunctionArguments> ")" "->" <Type> "|" "->" <Expression> ";": [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, _, NonTerminal(Symbol::GenericsTypeArguments((_, generics_arguments))), _, _, NonTerminal(Symbol::FunctionArguments((_, arguments))), _, _, NonTerminal(Symbol::Type((_, t))), Terminal(Token::Or(_)), _, NonTerminal(Symbol::Expression((_, expression))), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: mem::take(generics_arguments), arguments: mem::take(arguments), return_type: mem::take(t), expression: mem::take(expression) })));
            |"fn" [Identifier] "::" "<" <GenericsTypeArguments> ">" "(" <FunctionArguments> ")" "|" "->" <Expression> ";": [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, _, NonTerminal(Symbol::GenericsTypeArguments((_, generics_arguments))), _, _, NonTerminal(Symbol::FunctionArguments((_, arguments))), _, Terminal(Token::Or(_)), _, NonTerminal(Symbol::Expression((_, expression))), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: mem::take(generics_arguments), arguments: mem::take(arguments), return_type: Type::None, expression: mem::take(expression) })));
            |"fn" [Identifier] "(" <FunctionArguments> "," ")" "->" <Type> "|" "->" <Expression> ";": [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, NonTerminal(Symbol::FunctionArguments((_, arguments))), Terminal(Token::Comma(_)), _, _, NonTerminal(Symbol::Type((_, t))), Terminal(Token::Or(_)), _, NonTerminal(Symbol::Expression((_, expression))), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: Vec::new(), arguments: mem::take(arguments), return_type: mem::take(t), expression: mem::take(expression) })));
            |"fn" [Identifier] "(" <FunctionArguments> "," ")" "|" "->" <Expression> ";": [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, NonTerminal(Symbol::FunctionArguments((_, arguments))), Terminal(Token::Comma(_)), _, Terminal(Token::Or(_)), _, NonTerminal(Symbol::Expression((_, expression))), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: Vec::new(), arguments: mem::take(arguments), return_type: Type::None, expression: mem::take(expression) })));
            |"fn" [Identifier] "::" "<" <GenericsTypeArguments> ">" "(" <FunctionArguments> "," ")" "->" <Type> "|" "->" <Expression> ";": [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, _, NonTerminal(Symbol::GenericsTypeArguments((_, generics_arguments))), _, _, NonTerminal(Symbol::FunctionArguments((_, arguments))), Terminal(Token::Comma(_)), _, _, NonTerminal(Symbol::Type((_, t))), Terminal(Token::Or(_)), _, NonTerminal(Symbol::Expression((_, expression))), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: mem::take(generics_arguments), arguments: mem::take(arguments), return_type: mem::take(t), expression: mem::take(expression) })));
            |"fn" [Identifier] "::" "<" <GenericsTypeArguments> ">" "(" <FunctionArguments> "," ")" "|" "->" <Expression> ";": [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, _, NonTerminal(Symbol::GenericsTypeArguments((_, generics_arguments))), _, _, NonTerminal(Symbol::FunctionArguments((_, arguments))), Terminal(Token::Comma(_)), _, Terminal(Token::Or(_)), _, NonTerminal(Symbol::Expression((_, expression))), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: mem::take(generics_arguments), arguments: mem::take(arguments), return_type: Type::None, expression: mem::take(expression) })));
            |"fn" [Identifier] "(" ")" "->" <Type> "|" "->" <Expression> ";": [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, _, _, NonTerminal(Symbol::Type((_, t))), Terminal(Token::Or(_)), _, NonTerminal(Symbol::Expression((_, expression))), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: Vec::new(), arguments: Vec::new(), return_type: mem::take(t), expression: mem::take(expression) })));
            |"fn" [Identifier] "(" ")" "|" "->" <Expression> ";": [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, _, Terminal(Token::Or(_)), _, NonTerminal(Symbol::Expression((_, expression))), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: Vec::new(), arguments: Vec::new(), return_type: Type::None, expression: mem::take(expression) })));
            |"fn" [Identifier] "::" "<" <GenericsTypeArguments> ">" "(" ")" "->" <Type> "|" "->" <Expression> ";": [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, _, NonTerminal(Symbol::GenericsTypeArguments((_, generics_arguments))), _, _, _, _, NonTerminal(Symbol::Type((_, t))), Terminal(Token::Or(_)), _, NonTerminal(Symbol::Expression((_, expression))), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: mem::take(generics_arguments), arguments: Vec::new(), return_type: mem::take(t), expression: mem::take(expression) })));
            |"fn" [Identifier] "::" "<" <GenericsTypeArguments> ">" "(" ")" "|" "->" <Expression> ";": [Terminal(Token::Fn(Range { start, .. })), Terminal(Token::Identifier((_, name))), _, _, NonTerminal(Symbol::GenericsTypeArguments((_, generics_arguments))), _, _, _, Terminal(Token::Or(_)), _, NonTerminal(Symbol::Expression((_, expression))), Terminal(Token::Semicolon(Range { end, .. }))] => Ok(Symbol::FunctionDefinition((*start..*end, Function { position: *start..*end, name: name.clone(), generics_arguments: mem::take(generics_arguments), arguments: Vec::new(), return_type: Type::None, expression: mem::take(expression) })));
        <FunctionArguments>::=[Identifier] ":" <Type>: [Terminal(Token::Identifier((Range { start, .. }, name))), _, NonTerminal(Symbol::Type((Range { end, .. }, t)))] => Ok(Symbol::FunctionArguments((*start..*end, vec![(name.clone(), mem::take(t))])));
            |<FunctionArguments> "," [Identifier] ":" <Type>: [NonTerminal(Symbol::FunctionArguments((Range { start, .. }, list))), _, Terminal(Token::Identifier((_, name))), _, NonTerminal(Symbol::Type((Range { end, .. }, t)))] => Ok(Symbol::FunctionArguments((*start..*end, {
